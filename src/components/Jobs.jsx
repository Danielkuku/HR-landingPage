    ...
    <>
      <section className="section__container job__container" id="job">
        ...
        <p className="section__description">
          ...
          Available Now in Top Industries and Companies
        </p>
        ...
        <div className="job__grid">
          ...
          <div className="job__card">
            ...
            <p>
              ...
              of projects on schedule, while maintaining clear communication
              with stakeholders.
            </p>
            <div className="job__card__footer">
          ...
          <div className="job__card">
            ...
            <p>
              Specialize in building dynamic and interactive user interfaces
              using the ReactJS library, leveraging your expertise in JavaScript
